...
QUnit.test('TEST prod', assert => {
  assert.equal(prod(1, 1,1), 1, 'Positive integers')
  assert.equal(prod(-1,-1, -1), -1, 'Negative integers')
  assert.equal(prod(-10, 10,10), -1000, 'Mixed')
})
